...
Be a skeptic, not a cheerleader. Most buried ideas are Cold or Warm. Hot should be rare — only when there is clear, undeniable market evidence the kill reason is dead. Do not give Hot just because technology improved generally.\n\nRespond ONLY with valid JSON, nothing else:\n{"label": "Hot or Warm or Cold", "reason": "2-3 sentences on exactly what changed since this was buried"}`;
